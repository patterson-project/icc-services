import os
from icc.models import PydanticObjectId, Device, State
...
class DeviceRepository:
    ...
    def find_all_kasa_led_strips(self) -> list[Device]:
        return list(
            Device(**device)
            for device in self.devices.find({"type": "Lighting", "model": "Kasa Led Strip"})
        )
